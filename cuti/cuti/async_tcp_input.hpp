...
#ifndef CUTI_ASYNC_TCP_INPUT_HPP_
#define CUTI_ASYNC_TCP_INPUT_HPP_
 ...
 */
struct CUTI_ABI async_tcp_input_t : async_input_t
{
  explicit async_tcp_input_t(std::shared_ptr<tcp_connection_t> conn);
