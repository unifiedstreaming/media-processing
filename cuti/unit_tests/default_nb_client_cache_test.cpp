...
void test_connection_eviction(logging_context_t const& context)
{
  if(auto msg = context.message_at(loglevel_t::info))
  {
    *msg << __func__ << ": starting";
...
void test_connection_aging(logging_context_t const& context)
{
  if(auto msg = context.message_at(loglevel_t::info))
  {
    *msg << __func__ << ": starting";
...
void test_key_eviction(logging_context_t const& context)
{
  if(auto msg = context.message_at(loglevel_t::info))
  {
    *msg << __func__ << ": starting";
...
void test_key_aging(logging_context_t const& context)
{
  if(auto msg = context.message_at(loglevel_t::info))
  {
    *msg << __func__ << ": starting";
...
int run_tests(int argc, char const* const* argv)
{
  ...
  test_connection_eviction(context);
  test_connection_aging(context);
  test_key_eviction(context);
  test_key_aging(context);
