...
#else
#define ATOMIC_OR(ptr, mask)  __atomic_fetch_or(ptr, mask, __ATOMIC_ACQUIRE)
#define ATOMIC_AND(ptr, mask) __atomic_fetch_and(ptr, mask, __ATOMIC_ACQUIRE)
#define ATOMIC_INC(ptr)       __atomic_add_fetch(reinterpret_cast<volatile int32_t*>(ptr), 1, __ATOMIC_RELEASE)
#define ATOMIC_DEC(ptr)       __atomic_add_fetch(reinterpret_cast<volatile int32_t*>(ptr), -1, __ATOMIC_RELEASE)
#define ATOMIC_ADD(ptr, val)  __atomic_fetch_add(reinterpret_cast<volatile __typeof__(*(ptr))*>(ptr), (__typeof__(*(ptr) + 0))(val), __ATOMIC_ACQUIRE)
#define ATOMIC_STORE(ptr, val)    __atomic_exchange_n(reinterpret_cast<volatile int32_t*>(ptr), (int32_t)(val), __ATOMIC_RELEASE)
#define ATOMIC64_LOAD(ptr)        __atomic_fetch_add(reinterpret_cast<volatile int64_t*>(ptr), 0, __ATOMIC_ACQUIRE)
#define ATOMIC64_STORE(ptr, val)  __atomic_exchange_n(reinterpret_cast<volatile int64_t*>(ptr), val, __ATOMIC_RELEASE)
#define ATOMIC64_ADD(ptr, val)    __atomic_fetch_add(reinterpret_cast<volatile int64_t*>(ptr), val, __ATOMIC_ACQUIRE)
#endif
#define GIVE_UP_TIME()        usleep(0)
