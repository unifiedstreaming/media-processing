...
#include <x265_es_utils/service.hpp>
                           ...
                           std::size_t count)
{
  ...
  auto sample_headers_consumer = [&](x265_proto::sample_headers_t headers)
  {
                  ...
                  std::size_t frame_count)
{
  ...
  {
    x265_es_utils::service_t service(
